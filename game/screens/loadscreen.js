var loadscreen = new class extends Screen {

	constructor() {
		super(document.querySelector(".load.screen"));
	}
	
	showPage(page) {
		const currentPage = document.querySelector(".load.screen .page-viewer > .pages > *.visible");
		const targetPage = document.querySelector("#load-page-" + page);
